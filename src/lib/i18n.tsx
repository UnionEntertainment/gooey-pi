...
const englishCatalog = {
  ...
  'session.status.waiting': 'Waiting for input',
  'session.status.complete': 'Finished',
  'session.status.failed': 'Failed',
  'session.status.failedCleared': 'Failed — notification cleared',
  'session.status.unknown': 'Unknown',
  'session.meta.running': 'Working',
  'session.meta.waiting': 'Needs attention',
  'session.meta.complete': 'Finished',
  'session.meta.failed': 'Failed',
  'sidebar.empty.none': 'No projects yet',
  'sidebar.empty.filtered': 'No matching work',
  'sidebar.copied': 'Session UUID copied.',
  'sidebar.copyFailed': 'Copy is unavailable',
  ...
  'appearance.theme.aria': 'Interface theme',
...
const simplifiedChineseCatalog: Partial<Record<MessageKey, Message>> = {
  ...
  'session.status.failedCleared': '失败 — 通知已清除',
  'session.status.unknown': '未知',
  'session.meta.running': '工作中',
  'session.meta.waiting': '需要注意',
  'session.meta.complete': '已完成',
  'session.meta.failed': '失败',
  'sidebar.empty.none': '还没有项目',
  'sidebar.empty.filtered': '没有匹配的内容',
  'sidebar.copied': '已复制会话 UUID。',
  'sidebar.copyFailed': '无法复制',
